...
description: 'Annotations from building a single authentication microservice for RBAC and ABAC access control'
publishedAt: '2024-11-28'
tags: ['zettelkasten', 'system design']
author: 'Yan Fernandes'
summary: 'Annotations from building a single authentication microservice for RBAC and ABAC access control'
---
