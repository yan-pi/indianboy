...
tags: ['programming', 'vuejs', 'javascript', 'frontend']
author: 'Yan Fernandes'
summary: 'These are my notes from a presentation on Vue.js that I had during the weekly open-coding session of Bahia Devs.'
---
