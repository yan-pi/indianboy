we could select more than one tag to search
we should add github comments
adjust back button and add back to top button in the final of blog posts
add trable of contents to blog posts
